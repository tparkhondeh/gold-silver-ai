...
type PreviewResult = {
  ...
  persistence: { available: false; reason: string };
};
  ...
  return (
    <section className="panel operator-import" aria-labelledby="operator-import-title">
      <div className="panel-head operator-import-head">
        ...
        <span className="status-chip warning">ذخیره‌سازی قفل است</span>
      </div>
      ...
      <form onSubmit={previewCsv} className="operator-form">
        ...
        <div className="operator-actions">
          ...
          <button type="button" className="ghost-button" disabled title="پس از اتصال PostgreSQL فعال می‌شود">ثبت در PostgreSQL</button>
        </div>
      </form>
