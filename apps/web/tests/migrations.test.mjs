...
test("migration manifests are deterministic and never include transaction wrappers twice", async () => {
  ...
  assert.deepEqual(migrations.map((migration) => migration.id), ["0001_data_foundation.sql", "0002_audit_integrity.sql", "0003_owner_portfolio.sql", "0004_portfolio_preferences.sql", "0005_provenance_registry.sql", "0006_reconciliation_and_corrections.sql", "0007_transaction_valuation_ledger.sql", "0008_ledger_lineage_integrity.sql", "0009_ledger_replay_integrity.sql", "0010_provider_quota_ledger.sql", "0011_provider_runtime_status.sql", "0012_purchase_book.sql", "0013_private_owner_identity.sql", "0014_owner_passkeys.sql"]);
