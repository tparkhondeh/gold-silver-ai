...
def encode_methodology_evidence_gap_report(payload: object) -> bytes:
    return _encode_canonical(payload, validate_methodology_evidence_gap_report)


def decode_methodology_evidence_gap_report(document: object) -> dict[str, Any]:
    return _decode_canonical(document, validate_methodology_evidence_gap_report)


def encode_research_candidate_intake(
...
def decode_research_candidate_intake(
    document: object, gap_report_payload: object
) -> dict[str, Any]:
    return _decode_canonical(
        document,
        lambda value: validate_research_candidate_intake(value, gap_report_payload),
...
def encode_parameter_freeze_bundle(
    payload: object, manifest_payload: object
) -> bytes:
    return _encode_canonical(
        payload,
...
def decode_parameter_freeze_bundle(
    document: object, manifest_payload: object
) -> dict[str, Any]:
    return _decode_canonical(
        document,
...
def encode_calibration_readiness_report(
    payload: object,
    manifest_payload: object,
    freeze_payload: object,
    evidence_payload: object,
...
def decode_calibration_readiness_report(
    document: object,
    manifest_payload: object,
    freeze_payload: object,
    evidence_payload: object,
