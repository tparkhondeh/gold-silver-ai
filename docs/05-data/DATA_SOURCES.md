...
- Missing or invalid plan/cadence configuration falls back to the free policy. A free
  ...
  six-hour setting from exhausting a continuously running 31-day window. `/api/health`
