...
| B2 | Data pipeline scheduling & manual-update tooling | `docs/05-data/DATA_PIPELINE.md` | Standard ingestion-engineering practice | No | Manual CSV core implemented; UI/scheduling pending | Partially resolved |
