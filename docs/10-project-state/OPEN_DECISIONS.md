...
| A15 | Rotation engine methodology (thresholds, conviction communication) | `docs/04-portfolio/ROTATION_ENGINE.md` | Financial methodology | No | Design step of the rotation phase | Open |
